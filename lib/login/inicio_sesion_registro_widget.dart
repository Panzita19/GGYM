...
import 'inicio_sesion_registro_model.dart';
export 'inicio_sesion_registro_model.dart';

class InicioSesionRegistroWidget extends StatefulWidget {
  const InicioSesionRegistroWidget({super.key});

  static String routeName = 'InicioSesionRegistro';
...
class _InicioSesionRegistroWidgetState extends State<InicioSesionRegistroWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InicioSesionRegistroModel());
